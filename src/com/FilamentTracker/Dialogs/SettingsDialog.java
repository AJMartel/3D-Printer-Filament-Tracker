...
public class SettingsDialog extends JFrame
{
    ...
    private Document          doc                       = HTMLKit.createDefaultDocument();
    private JButton           applyButton               = new JButton("Apply");
    private JButton           cancelButton              = new JButton("Cancel");
    private JButton           saveLocationButton        = new JButton("...");
    private JCheckBox         promptOnExit              = new JCheckBox("Prompt on exit.");
    private JComboBox<String> minimizeToTrayComboBox    = new JComboBox<String>();
    private JComboBox<String> timestampComboBox         = new JComboBox<String>();
    private JComboBox<String> titleComboBox             = new JComboBox<String>();
    private JEditorPane       sampleEditorPane          = new JEditorPane();
    private JLabel            autoSaveLabel             = new JLabel("Auto save interval (minutes)");
    private JLabel            filamentBorderColorLabel  = new JLabel("Filament Border Color");
    private JLabel            filamentFillColorLabel    = new JLabel("Filament Fill Color");
    private JLabel            minizeToTrayLabel         = new JLabel("Minize to tray on exit");
    private JLabel            printBorderColorLabel     = new JLabel("Print Border Color");
    private JLabel            printFillColorLabel       = new JLabel("Print Fill Color");
    private JLabel            sampleOutputLabel         = new JLabel("Sample Output");
    private JLabel            saveLocationLabel         = new JLabel("Save File Location");
    private JLabel            settingsHeaderLabel       = new JLabel("General");
    private JLabel            tableDataColorLabel       = new JLabel("Table data Color");
    private JLabel            tableEvenColumnColorLabel = new JLabel("Table even column colors");
    private JLabel            tableHeaderColorLabel     = new JLabel("Table header Color");
    private JLabel            tableOddColumnColorLabel  = new JLabel("Table odd column colors");
    private JLabel            timestampColorLabel       = new JLabel("Timestamp Color");
    private JLabel            timestampTextAlignLabel   = new JLabel("Timestamp Align");
    private JLabel            timestampTextSizeLabel    = new JLabel("Timestamp Size");
    private JLabel            titleColorLabel           = new JLabel("Title Color");
    private JLabel            titleTextAlignLabel       = new JLabel("Title Align");
    private JLabel            titleTextSizeLabel        = new JLabel("Title Size");
    private JPanel            HTMLColorsPanel           = new JPanel();
    private JPanel            cardsPanel                = new JPanel();
    private JPanel            filamentBorderColorPanel  = new JPanel();
    private JPanel            filamentFillColorPanel    = new JPanel();
    private JPanel            generalPanel              = new JPanel();
    private JPanel            loggingPanel              = new JPanel();
    private JPanel            printBorderColorPanel     = new JPanel();
    private JPanel            printFillColorPanel       = new JPanel();
    private JPanel            reportsPanel              = new JPanel();
    private JPanel            tableDataColorPanel       = new JPanel();
    private JPanel            tableEvenColumnColorPanel = new JPanel();
    private JPanel            tableHeaderColorPanel     = new JPanel();
    private JPanel            tableOddColumnColorPanel  = new JPanel();
    private JPanel            timestampColorPanel       = new JPanel();
    private JPanel            titleColorPanel           = new JPanel();
    private JScrollPane       sampleScrollPane          = new JScrollPane(sampleEditorPane);
    private JSeparator        separator                 = new JSeparator();
    private JSeparator        separator_1               = new JSeparator();
    private JSeparator        separator_2               = new JSeparator();
    private JSpinner          autoSaveSpinner           = new JSpinner();
    private JSpinner          timestampTextSizeSpinner  = new JSpinner();
    private JSpinner          titleTextSizeSpinner      = new JSpinner();
    private JTextField        saveLocationTextField     = new JTextField();
    private StyleSheet        styleSheet                = HTMLKit.getStyleSheet();
