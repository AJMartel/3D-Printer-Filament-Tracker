...
public class StatsDialog extends JFrame {
	...
	private ArrayList<Double>	printsPerYear 		= new ArrayList<Double>();
	private String[]			months				= {"Jan" ,"Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
	private JButton 			decrementYearButton = new JButton("<<");
	private JButton 			incrementYearButton = new JButton(">>");
	private JLabel 				yearLabel 			= new JLabel();
	private JPanel 				totalStatsPanel 	= new JPanel();
	private JPanel	 			yearStatsPanel 		= new JPanel();
	private JToggleButton 		graphTogButton	 	= new JToggleButton("Number of Prints");
	private JToggleButton 		yearTotalTogButton 	= new JToggleButton("Yearly Data");
	private JPanel 				graphPanel 			= new JPanel();
	private JScrollPane 		yearStatsScrollPane	= new JScrollPane();
	private JScrollPane 		totalStatsScrollPane= new JScrollPane();
	private JTextPane 			totalStatsTextPane 	= new JTextPane();
	private JTextPane 			yearStatsTextPane 	= new JTextPane();
	 ...
	 * PRPOSE:		Refreshes the graph to show the new one with new data.
	 * 
